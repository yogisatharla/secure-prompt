...
const DEFAULT_GLOW_COLOR = '217, 164, 65'; // Brand gold tone
...
const defaultCardData: BentoCardData[] = [
  {
    ...
    description: 'Self-hosted architecture ensures prompts stay entirely within your browser and memory.',
    label: 'Privacy'
  },
  {
    color: '#1B2338',
    title: 'Real-time Redaction',
    description: 'Automatically detects and masks PII, credentials, access keys, and financial data.',
    label: 'Security'
  },
  {
    color: '#1B2338',
    title: 'Contextual Rewriting',
    description: 'Generates safe, anonymized prompt variations to preserve AI utility without data leakage.',
    label: 'AI Utility'
  },
  {
    color: '#1B2338',
    title: 'Dynamic Risk Scoring',
    description: 'Instant compliance risk metrics, categorization, and audit log preview prior to dispatch.',
    label: 'Compliance'
  }
];
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              backgroundColor: card.color || '#1B2338',
